...
public partial class ApbdCw10Context : DbContext
{
    public ApbdCw10Context()
    {
    }

    public ApbdCw10Context(DbContextOptions<ApbdCw10Context> options)
        : base(options)
    {
    }
...
//         => optionsBuilder.UseSqlServer("Server=np:\\\\.\\pipe\\LOCALDB#7A294E66\\tsql\\query;Database=APBD_CW10;Trusted_Connection=True;");
